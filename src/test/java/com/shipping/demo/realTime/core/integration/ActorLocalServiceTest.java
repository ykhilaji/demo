...
public class ActorLocalServiceTest {
  ...
  void setUp() throws Exception {
    ...
    actorRef = actorLocalService
        .createLocalActor("child-actor-" + UUID.randomUUID(), behavior::create, Duration.ofSeconds(1))
...
class SimpleActorBehavior implements SingletonBehavior<SimpleActorBehavior.Command> {
  ...
  public Behavior<Command> create() {
    return Behaviors.setup(
        context -> Behaviors.receive(Command.class)
