file://<WORKSPACE>/src/main/java/com/coliship/demo/realTime/core/common/SkipNullableCheck.java
...
action parameters:
uri: file://<WORKSPACE>/src/main/java/com/coliship/demo/realTime/core/common/SkipNullableCheck.java
text:
```scala
